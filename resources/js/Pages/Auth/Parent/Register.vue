  ...
  <div class="min-h-screen bg-[#F8FAFC] font-sans flex flex-col items-center">
    <nav class="max-w-7xl mx-auto w-full px-8 py-6 flex justify-between items-center bg-transparent">
      ...
      <div class="flex items-center space-x-8">
        <Link href="/masuk-orang-tua" class="text-blue-700 font-bold hover:underline">Masuk</Link>
        <button class="bg-blue-600 text-white px-8 py-2.5 rounded-lg font-bold shadow-md cursor-default">Daftar Orang Tua</button>
      </div>
    </nav>
    ...
    <div class="flex-1 w-full flex justify-center items-center p-6 max-w-7xl">
      <div class="bg-white rounded-[40px] shadow-sm w-full flex overflow-hidden border border-gray-100 min-h-[600px]">
        <div class="w-full md:w-1/2 p-12 lg:p-16 flex flex-col justify-center">
          <h1 class="text-4xl font-extrabold text-gray-900 mb-2">Daftar Sebagai <span class="text-green-600">Orang Tua</span></h1>
          <p class="text-gray-400 font-medium text-sm mb-10">Pantau perkembangan belajar anak Anda dengan mudah.</p>
          ...
          <form class="space-y-6" @submit.prevent="submit">
            ...
            <LesGoButton variant="secondary" :processing="form.processing" class="w-full">
              Daftar Sebagai Orang Tua
            </LesGoButton>
          </form>
          <div class="mt-6 text-center">
            <p class="text-sm font-medium text-gray-400">Sudah punya akun? <Link href="/masuk-orang-tua" class="text-blue-600 font-bold hover:underline">Masuk</Link></p>
          </div>
        </div>
        <div class="hidden md:flex w-1/2 bg-green-50 items-center justify-center">
          <div class="w-[90%] h-[90%] border-4 border-dashed border-green-100 rounded-[30px] flex flex-col items-center justify-center">
            <span class="text-9xl mb-6">👨‍👩‍👧‍👦🏠💖</span>
            <p class="text-green-600 font-bold text-lg text-center">Keluarga Bahagia<br>Masa Depan Terang</p>
          </div>
        </div>
      </div>
    </div>
