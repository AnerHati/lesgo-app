  ...
  <div class="min-h-screen bg-[#F8FAFC] font-sans flex flex-col items-center">
    ...
    <nav class="max-w-7xl mx-auto w-full px-8 py-6 flex justify-between items-center bg-transparent">
      ...
      <div class="flex items-center space-x-8">
        <button @click="goTo('/pilih-masuk')" class="text-blue-700 font-bold hover:underline cursor-pointer">
          Masuk
        </button>
      ...
      <div class="bg-white rounded-[40px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full flex overflow-hidden border border-gray-100 min-h-[600px] relative">
        ...
        <div class="w-full md:w-1/2 p-12 lg:p-16 flex flex-col justify-center z-10">
          ...
          <p class="text-gray-400 font-medium text-sm mb-10">
            Buat akun Vidya Loka untuk mulai belajar dengan tutor terbaik.
          </p>

          <form class="space-y-6" @submit.prevent="goTo('/lengkapi-profil')">

            <div>
              <label class="block text-sm font-bold text-gray-800 mb-2">Nama Lengkap <span class="text-red-500">*</span></label>
              <input type="text" placeholder="Kenzo Aliza" class="w-full px-4 py-3.5 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 outline-none placeholder-gray-400 transition-all">
            </div>
            ...
            <div class="pt-2">
              <p class="text-xs text-gray-400 font-medium leading-relaxed text-center md:text-left">
                Dengan membuat akun, saya telah menyetujui <a href="#" class="text-blue-600 font-bold hover:underline">Syarat</a><br class="hidden md:block">
                <a href="#" class="text-blue-600 font-bold hover:underline">& Ketentuan</a> serta <a href="#" class="text-blue-600 font-bold hover:underline">Kebijakan Privasi</a>
              </p>
            </div>
          ...
          <div class="mt-6 text-center">
            <p class="text-sm font-medium text-gray-400">
              Sudah memiliki akun?
              <button @click="goTo('/masuk-siswa')" class="text-blue-600 font-bold hover:underline">Masuk</button>
            </p>
          </div>
