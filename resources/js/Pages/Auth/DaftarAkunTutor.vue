      ...
      <div class="bg-white rounded-[40px] shadow-[0_8px_30px_rgb(0,0,0,0.04)] w-full flex overflow-hidden border border-gray-100 min-h-[600px] relative">
        ...
        <div class="w-full md:w-1/2 p-12 lg:p-16 flex flex-col justify-center z-10">
          <h1 class="text-4xl font-extrabold text-gray-900 mb-2">
            Daftar Sebagai <span class="text-[#FACC15]">Tutor</span>
          </h1>
          <p class="text-gray-400 font-medium text-sm mb-10">
            Buat akun Vidya Loka untuk mulai mengajar siswa terdekat dari Anda.
          </p>

          <form class="space-y-6" @submit.prevent="goToNextStep">
            ...
            <div class="pt-2">
              <p class="text-xs text-gray-400 font-medium leading-relaxed text-center md:text-left">
                Dengan membuat akun, saya telah menyetujui <a href="#" class="text-[#FACC15] font-bold hover:underline">Syarat</a><br class="hidden md:block">
                <a href="#" class="text-[#FACC15] font-bold hover:underline">& Ketentuan</a> serta <a href="#" class="text-[#FACC15] font-bold hover:underline">Kebijakan Privasi</a>
              </p>
            </div>

            <div class="pt-2">
              <button type="submit" class="w-full bg-[#FACC15] hover:bg-yellow-500 text-white font-bold py-4 rounded-xl shadow-md transition-colors text-lg">
          ...
          <div class="mt-6 text-center md:text-left pl-2">
            <p class="text-sm font-medium text-gray-400">
              Sudah memiliki akun? 
              <Link href="/masuk-tutor" class="text-[#FACC15] font-bold hover:underline ml-1">Masuk</Link>
            </p>
          </div>
